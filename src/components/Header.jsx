    ...
    <div className="flex justify-between items-center  p-4 sm:px-8 shadow-md rounded-lg mt-5">
      ...
      <div className="relative group hoverid">
        <div className="flex items-center space-x-2 cursor-pointer">
          <h1 className=" font-medium hidden sm:block">{user.displayName}</h1>
        ...
        >
          <ul className="flex flex-col space-y-2">
            <li className="hover:bg-black rounded-md px-3 py-2 hover:text-white  font-medium text-sm cursor-pointer transition">
              <Link to={"/"}> Home</Link>
            </li>
            <li className="hover:bg-black rounded-md px-3 py-2 hover:text-white font-medium text-sm cursor-pointer transition">
